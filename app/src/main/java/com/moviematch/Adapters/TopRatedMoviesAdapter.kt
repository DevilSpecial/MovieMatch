...
class TopRatedMoviesAdapter(private var data: List<MovieDataItem>, var cont: Context) : RecyclerView.Adapter<TopRatedMoviesAdapter.ViewHolder>() {
    ...
    fun updateData(newData: List<MovieDataItem>) {
        data = newData
